...
### Fixed
- Locked in backward-compatibility coverage for pre-0.15.0 SQLite stores, including automatic schema-v1 and schema-v2 additive migrations with preserved live messages
