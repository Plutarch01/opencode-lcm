...
Long-memory plugin for [OpenCode](https://github.com/sst/opencode) — archives older session context, compresses it into searchable summaries, and recalls relevant details when you need them.
